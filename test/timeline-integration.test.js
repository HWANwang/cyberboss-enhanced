...
test("timeline failure message prefers the root error over stack tail", () => {
  const message = buildTimelineFailureMessage({
    ...
    stderr: [
      ...
      "    at /workspace/cyberboss/node_modules/timeline-for-agent/src/infra/timeline/timeline-store.js:356:13",
      "    at withTimelineWriteLock (/workspace/cyberboss/node_modules/timeline-for-agent/src/application/timeline/shared.js:64:18)",
    ].join("\n"),
  });
